...
namespace HoaDon.Migrations
{
    ...
    [Migration("20241021031500_qlhdthong")]
    partial class qlhdthong
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("waHoadon.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("waHoadon.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("waHoadon.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("waHoadon.Models.Chitiethoadon", b =>
                {
                    b.HasOne("waHoadon.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("waHoadon.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
