...
namespace QuanLySinhVien_Database_First.Models
{
    public partial class qlhvContext : DbContext
    {
        ...
        public virtual DbSet<Lylich> LyLich { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LONGLEE;Initial Catalog=QLHV2;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Diemthi>(entity =>
            {
                ...
                entity.HasIndex(e => e.Msmh, "IX_diemthi_msmh");
            ...
            modelBuilder.Entity<Lylich>(entity =>
            {
                ...
                entity.HasIndex(e => e.Malop, "IX_lylich_malop");
